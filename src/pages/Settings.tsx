            ...
            <CardContent className="space-y-4">
              ...
              <div className="flex items-center justify-between">
                <div className="space-y-0.5">
                  ...
                  <p className="text-sm text-muted-foreground">
                    Get notified when tasks you're watching are updated
                  </p>
                </div>
                <Switch defaultChecked />
              </div>
              ...
              <div className="space-y-2">
                ...
                <div className="flex gap-2">
                  {['bg-blue-500', 'bg-purple-500', 'bg-green-500', 'bg-orange-500', 'bg-pink-500'].map((color) => (
                    <button
                      key={color}
                      className={`h-10 w-10 rounded-full ${color} border-2 border-transparent hover:border-primary transition-colors`}
                    />
                  ))}
                </div>
              </div>
